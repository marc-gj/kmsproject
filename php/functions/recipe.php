			...
			<div class = "w3-half">
				...
				<table id = "measurement-table" class = "w3-table">
					...
					<tr>
						...
						<td>$<span class = "tester" value = "<?php $item_cost = $item['amount'][$i]*($item['price'][$i]/($item['unit_per_case'][$i]*$item['amount_per_unit'][$i])); $item_cost_total+=$item_cost; $i++; echo $item_cost;?>"><?php echo number_format((float)$item_cost,2,'.',''); ?></span></td>
					</tr>
				<?php } ?>
					<tr>
						<td><b>Total Cost</b></td>
						<td>
						<td>$<span class = "tester" value = "<?php echo $item_cost_total; ?>"><b>$</b></span></td> 
					<tr>
				</table>
			</div>
			<div class = "w3-half">
